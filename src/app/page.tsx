...
export default function Home() {
  ...
  <div className="relative isolate px-6 pt-14 lg:px-8">
    ...
    <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-30">
      ...
      <div className="text-center">
        <h1 className="text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl">Platform for volunteers</h1>
        <p className="mt-8 text-lg font-medium text-pretty text-gray-500 sm:text-xl/8">Bridging the gap between young enthusiasts and corporations.<br></br> By the youth for the youth!</p>
          ...
          <div className="lg:pt-4 lg:pr-8">
            <div className="lg:max-w-lg">
              <h2 className="text-base/7 font-semibold text-teal-600">Engage more</h2>
                <p className="mt-2 text-4xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-5xl">A compact platform</p>
  ...
  <div className="mx-auto max-w-7xl px-6 lg:px-8">
    <h1 className="text-5xl w-full text-center mb-16">Why trust <span className="text-teal-700">KHUJO.org</span>?</h1>
